  ...
  return (
      <section className="container mx-auto px-4 py-8 grid gap-6 md:grid-cols-2 lg:grid-cols-2">
        {services.map((service, index) => (
            <div key={index} className="bg-white rounded-xl shadow-xl p-4 flex flex-col items-center">
              <div className="w-full h-48 md:h-72 overflow-hidden mb-4">
                <Image src={service.image} alt="Service" className="w-full h-full object-cover" />
              </div>
